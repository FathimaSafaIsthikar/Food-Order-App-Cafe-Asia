...
namespace Cafe_Asia
{
    public partial class Email : Form
    {
        ...
        {
            if (!Regex.IsMatch(txt_to.Text, @"^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$"))
            {
                e.Cancel = true;
                txt_to.Focus();
                errorProvider1.SetError(txt_to, "Enter a valid email. Ex:name@gmail.com");
            }
            else
            {
                e.Cancel = false;
                errorProvider1.SetError(txt_to, null);
